...
import sys
sys.path.append("/home/qinyixin/workspace/Medical_seg/EMCAD")
...
class EMCADNet(nn.Module):
    def __init__(self, num_classes=3, kernel_sizes=[1,3,5], expansion_factor=2, dw_parallel=True, add=True, lgag_ks=3, activation='relu', encoder='pvt_v2_b2', pretrain=True):
